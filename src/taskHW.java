public class taskHW {
    ...
    static void task0(){
        ...
        firstHomeWork.add("Кирилл", "1123131251");
        ...
        System.out.println(firstHomeWork.getByTel("11111111111"));
        System.out.println(firstHomeWork.getAll());
    }
}
